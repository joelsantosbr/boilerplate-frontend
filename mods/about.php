...
<div class="container">
  <div class="row">
    <section class="jumbotron">
      <h1>About - Model 1</h1>
      <h3>Requisitos:</h3>
      <p><strong>O código HTML dentro deste arquivo! entre o comentário "<*!-- About - Model 1 -->"</strong></p>
      <p><strong>O arquivo Stylus na pasta raiz <em>/src/assets/stylus/components/mod-about-1.styl</em></strong></p>
    </section>
  </div>
</div>
